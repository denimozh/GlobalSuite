...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[240vh] flex flex-col items-center py-0 md:pt-80 md:pb-60 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-5xl font-bold mb-36 text-center"
      >
        {title || (
          <span>
